...
```
Please NOTE down this **PASSWORD** as you will need when you log on to RStudio from a browser.
...
* We are **using Singularity to execute** (`singularity exec`) the prepared RStudio container (`/cvmfs/data.biocommons.aarnet.edu.au/training_materials/SIH_training/IntroRNAseq_1023/rstudio_4.1.0.sif`) 
...
PASSWORD=$RSERVER_PASSWORD singularity exec \
        -B ~/Day-2/rstudio-server:/var/lib/rstudio-server \
        -B ~/Day-2/rstudio-server:/var/run/rstudio-server \
        -B ~/Day-2:/home \
