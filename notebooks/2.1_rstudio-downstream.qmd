...
```bash
mkdir /home/training/Day-2/rstudio-server
```
...
```
**Please NOTE down this PASSWORD** as you will need it after a few steps.
...
PASSWORD=$RSERVER_PASSWORD singularity exec \
        -B /home/training/Day-2/rstudio-server:/var/lib/rstudio-server \
        -B /home/training/Day-2/rstudio-server:/var/run/rstudio-server \
        -B /home/training/Day-2:/home \
